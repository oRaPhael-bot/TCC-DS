...
<body>
    <div class="w3-menu">
        <div class="w3-bar w3-card w3-white w3-top" id="menu-professor">
            ...
            <div class="w3-right w3-hide-small w3-margin">
                ...
                <a href="#avaliações" class="w3-bar-item w3-button"><i class="fa fa-file"></i>  AVALIAÇÕES</a>
                <a href="#professores" class="w3-bar-item w3-button"><i class="fa fa-user"></i> ALUNOS</a>
        ...
        <header>
            ...
            <div class="w3-display-left w3-text-white" style="padding:50px">
                ...
                <p><a href="#sobre" class="w3-button w3-large w3-white w3-padding-xlarge w3-opacity w3-animate-opacity w3-margin-top">Organize suas aulas</a></p>
 
            </div>
        </header>
 
        <div class="w3-container" style="padding:120px 16px" id="about">
            <h2 class="w3-center">PILARES DO NOSSO ENSINO</h2>  
            <div class="w3-row-padding w3-center" style="margin-top:64px">
                <div class="w3-quarter w3-card w3-container " style="min-height:430px">
                    <i class="fa fa-desktop w3-margin-bottom w3-jumbo w3-center"style="margin-top:64px"></i>
                    <p class="w3-large ">Responsabilidade</p>
                    <p>Foco nos horários e metas em ralação ao conteúdo a ser transmitido</p>
                </div>
                <div class="w3-quarter w3-card w3-container w3-black" style="min-height:430px">
                    <i class="fa fa-heart w3-margin-bottom w3-jumbo" style="margin-top:64px"></i>
                    <p class="w3-large">Comprometimento</p>
                    <p>Valorização de cada detalhe no ensino que possa fazer a diferença, sempre valorizando o relacionamento com os alunos</p>
                </div>
                <div class="w3-quarter w3-card w3-container " style="min-height:430px">
                    <i class="fa fa-diamond w3-margin-bottom w3-jumbo" style="margin-top:64px"></i>
                    <p class="w3-large">Organização</p>
                    <p>Organização correta das aulas e dos materiais para transmitir os conhecimentos com qualidade</p>
                </div>
                <div class="w3-quarter w3-card w3-container w3-black" style="min-height:430px">
                    <i class="fa fa-cog w3-margin-bottom w3-jumbo" style="margin-top:64px"></i>
                    <p class="w3-large">Suporte</p>
                    <p>Estar presente em todos os momentos de necessidades e dúvidas dos alunos, fazendo com que a qualidade do ensino seja de excelência</p>
                </div>
            </div>
        </div>
    </div>
    <div>
        <div class="w3-container w3-light-grey" style="padding:110px 50px 110px" >
            <div class="w3-row-padding w3-center">
                <div class="w3-col m6"style="padding:100px 16px">
                    <h3>ACESSE O NOSSO FORUM</h3>
                    <p>Responda dúvidas e opiniões dos alunos focando na valorização de cada indivíduo</p>
        ...
        <div class="w3-container" style="padding-top:50px; margin-bottom: 100px;" id="slide">
            <h2 class="w3-center">AULAS INTERATIVAS</h2><br>
